...
public class PersonHandler {
    ...
    private int createdProfileCount = 0;

    public int getCreatedProfileCount() {
        return createdProfileCount;
    }

    public void setCreatedProfileCount(int createdProfileCount) {
        this.createdProfileCount = createdProfileCount;
    }
