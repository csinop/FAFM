...
public class create_profile_next extends AppCompatActivity {
    ...
    public void onClickDisableAllAndSaveActivityLevel(@NonNull View v){
        ...
        if(v.getId() == R.id.often1) personHandler.saveStringToSharedPreferences(preference, StaticProfilePreferenceStrings.PROFILE_ACTIVITY,"1.2");
        else if(v.getId() == R.id.often2) personHandler.saveStringToSharedPreferences(preference, StaticProfilePreferenceStrings.PROFILE_ACTIVITY, "1.375");
        else if(v.getId() == R.id.often3) personHandler.saveStringToSharedPreferences(preference, StaticProfilePreferenceStrings.PROFILE_ACTIVITY, "1.55");
        else if(v.getId() == R.id.often4) personHandler.saveStringToSharedPreferences(preference, StaticProfilePreferenceStrings.PROFILE_ACTIVITY, "1.725");
        else if(v.getId() == R.id.often5) personHandler.saveStringToSharedPreferences(preference, StaticProfilePreferenceStrings.PROFILE_ACTIVITY, "1.9");
        else return;
