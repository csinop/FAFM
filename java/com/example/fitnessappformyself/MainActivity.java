...
public class MainActivity extends AppCompatActivity {
    ...
    public void setFragments(){
        ...
        Objects.requireNonNull(tabLayout.getTabAt(0)).setIcon(R.drawable.ic_outline_calendar_today_24);
        Objects.requireNonNull(tabLayout.getTabAt(1)).setIcon(R.drawable.ic_outline_message_24);
        Objects.requireNonNull(tabLayout.getTabAt(2)).setIcon(R.drawable.ic_outline_sports_handball_24);
        Objects.requireNonNull(tabLayout.getTabAt(3)).setIcon(R.drawable.ic_outline_info_24);
    }
