...
public class CalendarFragment extends Fragment implements AsyncResult<String> {
    ...
    public void onClickImport(){
        ...
        /* if the filePath is empty, then the user has not picked a file yet
        ...
        if(filePath.equals("")){
            ...
            importer.delegate = this;
            importer.execute();
            // what if import fails though?
            // we need live feedback for that which I have not implemented yet.
        }
    }

    @Override
    public void onTaskFinish(String result) {
        //enable this for testing, otherwise it is not necessary.
    ...
    public static class ImportAsync extends AsyncTask<Void, Integer, String> {
        //to pass the result of execution
        ...
        protected void onPreExecute(){
            ...
            /* disable the import button when import task begins */
            Button importButton = fragmentReference.get().requireActivity().findViewById(R.id.import_button);
        ...
        protected void onPostExecute(String str) {
            ...
            /* enable the import button when import task ends */
            Button importButton = fragmentReference.get().requireActivity().findViewById(R.id.import_button);
    ...
    public static class ExportAsync extends AsyncTask<Void, Integer, String> {
        //to pass the result of execution
        public AsyncResult<String> delegate;
        ...
        protected void onPreExecute(){
            ...
            /* disable the export button when export task begins */
            Button exportButton = fragmentReference.get().requireActivity().findViewById(R.id.export_button);
        ...
        protected void onPostExecute(String str) {
            ...
            /* enable the export button when export task ends */
            Button exportButton = fragmentReference.get().requireActivity().findViewById(R.id.export_button);
