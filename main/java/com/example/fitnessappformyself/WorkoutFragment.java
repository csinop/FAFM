...
public class WorkoutFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        setOnClickListenerForEveryOtherButton(rootView,R.id.chest_layout);
        setOnClickListenerForEveryOtherButton(rootView,R.id.biceps_layout);
        setOnClickListenerForEveryOtherButton(rootView,R.id.triceps_layout);
        setOnClickListenerForEveryOtherButton(rootView,R.id.back_layout);
        setOnClickListenerForEveryOtherButton(rootView,R.id.legs_layout);
        setOnClickListenerForEveryOtherButton(rootView,R.id.shoulders_layout);
        setOnClickListenerForEveryOtherButton(rootView,R.id.cardio_layout);
        return rootView;
    }
    public void setOnClickListenerForEveryOtherButton(@NonNull View rootView, @IdRes int layoutId){
    ...
    public void saveRepsAndSets(View v){
        ...
        if(!(workoutCardSetInput.getText().toString().isEmpty()) && !(workoutCardRepInput.getText().toString().isEmpty())){
            ...
            try {
                ...
                saveCurrentMoveAndHideWorkoutCard();
    ...
    public void saveCurrentMoveAndHideWorkoutCard(){
        saveExerciseByView();
        cancelWorkoutCard();
        changeOccurred = true;
    ...
    public void saveExerciseByView(){
