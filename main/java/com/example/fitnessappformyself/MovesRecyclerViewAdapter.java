...
public class MovesRecyclerViewAdapter extends RecyclerView .Adapter<MovesRecyclerViewAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        initializeFragment(holder, currentBodyPart, position, currentWorkoutList);
    ...
    /*/INITIALIZE FRAGMENT/*/
    public void initializeFragment(ViewHolder holder, String bodyPart, int position, ArrayList<WorkoutMove> aList){
        initializeCheckBoxLayout(holder, position);
        if(onCreateFillMoveList(bodyPart,aList)) {
            hideAlreadyAdded(holder, bodyPart, aList);
        }
    }
