...
public class ProfActivity extends AppCompatActivity {
    ...
    public void initializeFieldsProfileOne(){
        ...
        ((TextView) findViewById(R.id.profName3)).setText(preferences.getString("name1",null));
        ((TextView) findViewById(R.id.profAge3)).setText(Integer.toString(preferences.getInt("age1",0)));
        ((TextView) findViewById(R.id.profWeight3)).setText(preferences.getString("weight1",null));
        ((TextView) findViewById(R.id.profHeight3)).setText(preferences.getString("height1",null));
    ...
    public void setProgressBarForActivityLevel(){
        ProgressBar progressBar = (ProgressBar) findViewById(R.id.activityProgressBarOne);
        SharedPreferences preferences = this.getSharedPreferences("Profiles1", Context.MODE_PRIVATE);
    ...
    public void setProgressBarForBodyFat(){
        ...
        if(preference.getString("gender1",null).equals("male")){
            ...
            else if(bodyFat <= 18.0 && bodyFat > 14.0) {//athletes and fitnes
                progressBar.setProgressDrawable(getResources().getDrawable(R.drawable.progress_bar_gradient_37percent));
    ...
    public void reverseVisibility(View v){
        SharedPreferences preference = this.getSharedPreferences("Profiles1", MODE_PRIVATE);
        final ConstraintLayout bodyFatLayout = (ConstraintLayout) findViewById(R.id.bodyFatCalcLayout);
    ...
    ////ON CLICK METHODS////
    public void onClickDeleteProfile(View v){
    ...
    @SuppressLint("SetTextI18n")
    public void onClickSaveAndDisplayBodyfat(View v){
        SharedPreferences preference = this.getSharedPreferences("Profiles1", MODE_PRIVATE);
    ...
    public void onClickEnableBodyFatCalcs(View v){
        SharedPreferences preference = this.getSharedPreferences("Profiles1", MODE_PRIVATE);
        final ConstraintLayout bodyFatLayout = (ConstraintLayout) findViewById(R.id.bodyFatCalcLayout);
