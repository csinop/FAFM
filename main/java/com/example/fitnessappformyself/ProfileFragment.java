...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        FloatingActionButton deleteProfile = rootView.findViewById(R.id.deleteProfile);
        deleteProfile.setOnClickListener(deleteButtonListener);

        //ButtonListeners
        Button calculateBodyFat = rootView.findViewById(R.id.calculateBodyFat);
        calculateBodyFat.setOnClickListener(enableCalcsListener);

        Button bodyFatCalcCancel = rootView.findViewById(R.id.bodyFatCalcCancel);
        bodyFatCalcCancel.setOnClickListener(cancelCalcsListener);

        Button saveBodyFatButton = rootView.findViewById(R.id.saveBodyFatButton);
        saveBodyFatButton.setOnClickListener(saveBodyFatListener);

        //ImageButtonListeners
        ImageButton save_edit_changes_name = rootView.findViewById(R.id.save_edit_changes_name);
        save_edit_changes_name.setOnClickListener(saveButtonListeners);
        ImageButton save_edit_changes_age = rootView.findViewById(R.id.save_edit_changes_age);
        save_edit_changes_age.setOnClickListener(saveButtonListeners);
        ImageButton save_edit_changes_weight = rootView.findViewById(R.id.save_edit_changes_weight);
        save_edit_changes_weight.setOnClickListener(saveButtonListeners);
        ImageButton save_edit_changes_height = rootView.findViewById(R.id.save_edit_changes_height);
