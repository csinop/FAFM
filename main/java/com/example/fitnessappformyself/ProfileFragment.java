...
public class ProfileFragment extends Fragment {
    ...
    private TextView bodyFatTag1;
    private TextView bodyFatDisplay1;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState){
        ...
        bodyFatTag1 = (TextView) requireView().findViewById(R.id.bodyFatTag1);
        bodyFatDisplay1 = (TextView) requireView().findViewById(R.id.bodyFatDisplay1);
        bodyFatUnit = (TextView) requireView().findViewById(R.id.bodyFatUnit);
    ...
    public void fillPersonalInfo(@NonNull View rootView){
        ...
        TextView bodyFatDisplay1 = (TextView) rootView.findViewById(R.id.bodyFatDisplay1);
